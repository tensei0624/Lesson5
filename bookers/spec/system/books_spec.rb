  ...
  describe "一覧画面のテスト" do
    ...
    context '投稿処理に関するテスト' do
      ...
      it '投稿後のリダイレクト先は正しいか', spec_category: "CRUD機能に対するコントローラーの処理と流れ" do
        ...
        fill_in 'book[body]', with: Faker::Lorem.characters(number:20)
        click_button 'Create Book'
        expect(page).to have_current_path show_books_path(Book.last)
      end
    end
  ...
  describe '編集画面のテスト' do
    ...
    context '更新処理に関するテスト' do
      ...
      it '更新後のリダイレクト先は正しいか', spec_category: "バリデーションとメッセージ表示" do
        ...
        fill_in 'book[body]', with: Faker::Lorem.characters(number:20)
        click_button 'Update Book'
        expect(page).to have_current_path show_books_path(book)
      end
    end
  end
end